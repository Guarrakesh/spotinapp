...
import {Alert, Animated, Image, InteractionManager, Platform, Text} from "react-native";
        ...
        >
          ...
          <View style={styles.content}>
            ...
            <Text style={styles.subtitle} allowFontScaling={false}>
              {
                t("location.needLocation")
              }</Text>
            <Button round
                    block
                    containerStyle={styles.button}
                    onPress={this.currentLocationPress} variant="primary" uppercase>
              {this.state.loading ?
                  t('location.fetching')
