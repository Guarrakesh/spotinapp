      ...
      <View elevation={1} style={styles.innerContainer}>
        <View style={styles.topContainer}>
          <ImageBackground
            ...
            source={{uri: business.image_url ? business.image_url[0].url: ""}}
          ...
          >
            <View style={styles.overlayView}>
              <View style={{flexDirection: 'column', justifyContent: 'flex-end', borderTopLeftRadius: themes.base.borderRadius}}>
                ...
                <Text style={styles.address}>{business.address.street} {business.address.number}, {business.address.city} ({business.address.province})</Text>
              </View>
